...
var testFunctions = map[string]func(*util.Context, string) (*TestResult, error){
	...
	"vanadium-javascript-build-extension":     vanadiumJSBuildExtension,
	"vanadium-javascript-doc":                 vanadiumJSDoc,
	"vanadium-javascript-browser-integration": vanadiumJSBrowserIntegration,
	"vanadium-javascript-node-integration":    vanadiumJSNodeIntegration,
	"vanadium-javascript-unit":                vanadiumJSUnit,
	"vanadium-javascript-vdl":                 vanadiumJSVdl,
	"vanadium-javascript-vom":                 vanadiumJSVom,
