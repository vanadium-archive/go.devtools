...
func vanadiumAndroidBuild(ctx *util.Context, testName string, _ ...TestOpt) (_ *TestResult, e error) {
	// Initialize the test.
...
func vanadiumAndroidTest(ctx *util.Context, testName string, _ ...TestOpt) (_ *TestResult, e error) {
	// Initialize the test.
	cleanup, err := initTest(ctx, testName, []string{"mobile"})
	if err != nil {
		return nil, internalTestError{err, "Init"}
...
func buildAndroidApp(ctx *util.Context, appDir string) error {
...
func buildAndroidLibs(ctx *util.Context, appDir string) error {
	rootDir, err := util.VanadiumRoot()
	if err != nil {
		return err
	}
...
func createAndroidAntFile(ctx *util.Context, appDir string, properties androidAntProperties) error {
