...
func runProjectTest(ctx *util.Context, testName, projectName, target string, env map[string]string, profiles []string) (_ *TestResult, e error) {
	// Initialize the test.
...
func vanadiumPipe2BrowserTest(ctx *util.Context, testName string, _ ...TestOpt) (*TestResult, error) {
