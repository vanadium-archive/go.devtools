...
var testFunctions = map[string]func(*jiri.X, string, ...Opt) (*test.Result, error){
	...
	"vanadium-website-config-deploy-prod":     vanadiumWebsiteConfigDeployProduction,
	"vanadium-website-config-deploy-stag":     vanadiumWebsiteConfigDeployStaging,
	"vanadium-website-deploy-production":      vanadiumWebsiteDeployProduction,
	"vanadium-website-deploy-staging":         vanadiumWebsiteDeployStaging,
